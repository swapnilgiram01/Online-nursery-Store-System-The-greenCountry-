...
import com.project.online_nursery_store.repository.UserRepository;
...
public class UserController {
	...
	public List<User> getUserByName(@PathVariable(value = "type") String level_id) {
			return userRepository.serchUserByType(level_id);
	}
